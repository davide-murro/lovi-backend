...
namespace LoviBackend.Data.Migrations
{
    ...
    [Migration("20260414123911_ChangeContentHtmlToFilePath")]
    partial class ChangeContentHtmlToFilePath
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.AudioBook", b =>
                {
                    ...
                    b.Property<string>("CoverImagePreviewPath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.EBook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.EBookWriter", b =>
                {
                    ...
                    b.HasKey("EBookId", "CreatorId");

                    b.HasIndex("CreatorId");

                    b.ToTable("EBookWriters");
                });
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.EBookWriter", b =>
                {
                    ...
                    b.HasOne("LoviBackend.Models.DbSets.EBook", "EBook")
                        .WithMany("Writers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LoviBackend.Models.DbSets.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
