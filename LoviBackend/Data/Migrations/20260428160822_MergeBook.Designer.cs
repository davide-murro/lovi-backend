...
namespace LoviBackend.Data.Migrations
{
    ...
    [Migration("20260428160822_MergeBook")]
    partial class MergeBook
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.BookReader", b =>
                {
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.BookWriter", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LoviBackend.Models.DbSets.BookReader", b =>
                {
                    b.HasOne("LoviBackend.Models.DbSets.Book", "Book")
                        .WithMany("Readers")
